...
1. Criar um **TAD Conjunto** a partir dos dados de entrada, usando como estrutura de dados uma tabela de dispersão usando **encadeamento**.
1. Criar um **TAD Conjunto** a partir dos dados de entrada, usando como estrutura de dados uma tabela de dispersão usando **endereçamento aberto**.
